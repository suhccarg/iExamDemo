...
//            try! gotoMessageView(message: log(10, ":\(e)"))
  ...
  private func setupGotoAnswerButton() throws {
       ...
       config.align = .right
       config.activeStates = [ ViewType.question ]
   ...
   private func setupGotoBackButton() throws {
       ...
       config.targetView = config.baseView
       config.align = .center
       config.activeStates = [  ViewType.answer ]
   ...
   private func setupGotoNewExamButton() throws {
       ...
       config.targetView = config.baseView
       config.align = .center
       config.activeStates = [  ViewType.review ]
   ...
   private func setupBreakButton() throws {
       ...
       config.targetView = config.baseView
       config.align = .left
       config.activeStates = [  ViewType.question, .answer ]
  ...
  private func setupWebView() throws {
   ...
   @objc private func onGotoAnswerButtonListener(_ sender: UIButton) {
       log(90, "gotoAnswerButton tapped.")
       try! gotoAnswer()
   ...
   @objc private func onGotoNewExamButtonListener(_ sender: UIButton) {
       log(90, "gotoNewExamButton tapped.")
       _ = try! setupExam()
       try! startExam()
       try! gotoQuestion()
